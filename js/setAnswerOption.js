const questionSelect = () => {
  ...
  fetchPage("https://quizzone-server.onrender.com/question/list/");
};
questionSelect();
...
const addAnswerOption = (event) => {
  ...
  fetch(`https://quizzone-server.onrender.com/question/list/${questionId}/`)
  .then(res=>res.json())
  .then(data=>{
    const question = {     
        "name": data.name,
    ...
    fetch("https://quizzone-server.onrender.com/question/answer_option/", {
      method: "POST",
      headers: {
